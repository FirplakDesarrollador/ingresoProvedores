...
async function run() {
    try {
        ...
        console.log("Fetching AC 43498153-01...");
        const res = await sapRequest(`${baseUrl}/BusinessPartners('AC 43498153-01')?$select=SubjectToWithholdingTax,BPWithholdingTaxCollection`, { headers });
