...
async function main() {
    ...
    // Get a recent supplier
    const bpRes = await sapRequest(`${baseUrl}/BusinessPartners?$filter=GroupCode eq 101&$top=1`, { headers });
    console.log("Extranjero DebPayAcct:", bpRes.data.value[0]?.DebPayAcct);
}
main();
